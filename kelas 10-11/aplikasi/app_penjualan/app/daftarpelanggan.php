...
<table width="519" border="1" class="w3-table-all w3-card-4">
  <caption align="top">
    <center></h3>Daftar Pelanggan</h3></center>
  </caption>
  <tr>
    <th width="25" scope="col">No</th>
    <th width="103" scope="col">Kode Pelanggan </th>
    <th width="128" scope="col">Nama  </th>
    <th width="60" scope="col">Alamat</th>
...
<?php
//siapkan query untuk mengmbil semua data pelanggan yang ada
include "koneksi.php";
$sql = "SELECT * FROM pelanggan";
$kueri = mysqli_query($koneksi, $sql);
//karena datanya lebih dari 1 record maka gunakan while
//semua data disimpan dalam array
//loopnr untuk menampilkan data pelanggan
$no = 1;
while($data = mysqli_fetch_array($kueri)){
    ...
    <tr>
        ...
        // kodepelanggan adalah nama field yang ada di tabel
        echo $data['kodepelanggan']?></td>
        <td><?php echo $data['nama']?></td>
        <td><?php echo $data['alamat'];?></td>
        <td><?php echo $data['pekerjaan']?></td>
        <td><!-- buat link untuk edit dan delete dan berikan parameter dgn nama "kode"-->
        <a href="editpelanggan.php?kode=<?php 
        echo $data['kodepelanggan']?>">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
        ...
        </td><td><a href="delete2.php?kode=<?php 
        echo $data['kodepelanggan']?>">
