...
include '../koneksi.php';
$donasi = new Donasi();
foreach ($donasi->edit($_GET['id']) as $data) {
    $id = $data['id'];
    ...
    <fieldset>
        ...
        <form action="proses.php" method="post">
            ...
            <tr>
                ...
                <tr>
                    <th>Metode Donasi</th>
                    <td><input type="text" name="metode_donasi" value="<?php echo $metode_donasi; ?>" required></td>
                </tr>
                <tr>
                    <th>Total Donasi</th>
                    <td><input type="number" name="total_donasi" value="<?php echo $total_donasi; ?>" required></td>
                </tr>
                <tr>
                    <th>Keterangan</th>
