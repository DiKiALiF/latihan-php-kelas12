...
foreach ($dataanak->edit($_GET['id']) as $data) {
    $id = $data['id'];
    $nama = $data['nama'];
        ...
        <form action="proses.php" method="post">
            ...
            <th>Nama Anak</th>
                ...
                <label for="exampleInputEmail1">Nama Pengasuh</label>
                        <select name="nama_pengasuh" name ="nama_pengasuh" class="form-control">
                            <option value=""><?php echo $data['nama_pengasuh'] ?></option>
                         </select>
                <tr>
                    <th>Tempat Lahir</th>
                ...
                <tr>
                    <th>Pendidikan</th>
                    <td><input type="text" name="pendidikan" value="<?php echo $pendidikan; ?>" required></td>
                </tr>
                <tr>
                    <th>Nama Ortu/Wali</th>
                    <td><input type="text" name="nama_ortu_wali" value="<?php echo $nama_ortu_wali; ?>" required></td>
                </tr>
                <tr>
                    <th>Alamat</th>
