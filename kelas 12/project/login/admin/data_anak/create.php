...
<h2><center>Tambah Data Pengasuh</center></h2>
  ...
  <label for="exampleFormControlSelect1">Jenis Kelamin</label>
    ...
    <div class="form-group">
    <label for="exampleInputEmail1">Nama Ortu/Wali</label>
    <input type="text" name="nama_ortu_wali"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>     
    <div class="form-group">
